...
func (_m *LikeRepository) DeleteLike(c context.Context, ProductID primitive.ObjectID, userID primitive.ObjectID) error {
...
func (_m *LikeRepository) GetLike(ctx context.Context, userID primitive.ObjectID, ProductID primitive.ObjectID) (*domain.Like, error) {
...
func (_m *LikeRepository) LikeProduct(c context.Context, ProductID primitive.ObjectID, userID primitive.ObjectID) error {
	ret := _m.Called(c, ProductID, userID)
...
func (_m *LikeRepository) UnLikeProduct(c context.Context, ProductID primitive.ObjectID, userID primitive.ObjectID) error {
	ret := _m.Called(c, ProductID, userID)
